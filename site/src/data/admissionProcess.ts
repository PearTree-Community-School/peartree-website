...
export const admissionProcess: ProcessStep[] = [
  ...
  { step: '3', title: 'Financial Aid Conversation', desc: "We'll have an open conversation about tuition and the financial aid options that apply to your family — need-based aid, sliding scale, and more." },
